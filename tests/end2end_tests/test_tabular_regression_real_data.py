...
def test_tabular_regressor(load_data_func, modlee_trainer, model_type):
    X, y = load_data_func()
...
if __name__ == "__main__":
    test_tabular_regressor(load_california_housing_data, False, TabularRegressionWithLayerNorm)
